<%-- 
    Document   : productHomeTheatre
    Created on : Apr 11, 2015, 7:21:21 PM
    Author     : Ravindu
--%>
...
<html lang="en">
  ...
  <body onload="startclock()">
    ...
    <div class="single-product-area">
        ...
        ResultSet rset = stmt.executeQuery("SELECT product_image_name, title, ProductCode, Price, old_price FROM product WHERE Category = 'hometheater' ");
        %>
            <div class="row">
            <%
            while(rset.next()){ 
