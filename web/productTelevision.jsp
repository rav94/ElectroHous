<%-- 
    Document   : productTelevision
    Created on : Apr 11, 2015, 7:20:00 PM
    Author     : Ravindu
--%>
...
<html lang="en">
  ...
  <body onload="startclock()">
    ...
    <div class="single-product-area">
        ...
        ResultSet rset = stmt.executeQuery("SELECT product_image_name, title, Price, old_price FROM product WHERE Category = 'television' ");
        %>
            <div class="row">
            <%
            while(rset.next()){ 
            ...
            <form action="cartAdd" method="post">
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <h2><input type="text" name="title" hidden="true" value="<%=rset.getString(2) %>" > <a href=""><%=rset.getString(2)%></h2>
